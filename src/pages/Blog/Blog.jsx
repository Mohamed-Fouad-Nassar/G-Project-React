...
function Blog() {
  ...
  const articleDes = `Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa
          consequatur ullam excepturi dolores repellat.`;

  const handleClick = () => {
    console.log("blog handle click function");
  };

  return (
    <div className={`${styles.container} container`}>
      <HeadSection title="blog" description={description} />
