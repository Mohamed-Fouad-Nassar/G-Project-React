...
function EditHospital() {
  ...
  useEffect(() => {
    if (singleHospital) {
      setName(singleHospital.name);
      setDescription(singleHospital.description);
      setLocation(singleHospital.location);
      setEmail(singleHospital.email);
      setPhoneNumber(singleHospital.phoneNumber);
      setImage(singleHospital.image);
      setFacebookLink(singleHospital.facebook);
      setInstagramLink(singleHospital.instagram);
      setTwitterLink(singleHospital.twitter);
      setWhatsappNumber(singleHospital.whatsapp);
    }
  }, [singleHospital]);
  ...
  const submitForm = (e) => {
    ...
    dispatch(editHospital(hospital));
  };

  // const imagePreviewRef = useRef();

  return (
    <DoctorModal backUrl={"/dashboard/hospitals"} title={"edit hospital"}>
