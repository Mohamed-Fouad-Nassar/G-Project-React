...
import { removePharmacy } from "../../store/slices/pharmacySlice";
        ...
        <div>
          ...
          <div className={styles["sec-body"]}>
            <DashInfoSection
              ...
              number={pharmacies.length}
              isReverse={true}
            />
            <div className={styles.control}>
              <Table titles={["title", "modifyDate"]}>
                {pharmacies.map(({ id, name, creationAt }, index) => (
                  <TableCol
                    key={id}
                    id={++index}
                    title={name}
                  ...
                  >
                    <span>
                      <Link to={`/dashboard/pharmacies/${id}/edit`}>
                        <i
                          className={`${styles["f-icon"]} fa-solid fa-pencil`}
                        />
                      </Link>
                      <Link to={`/dashboard/pharmacies/${id}`}>
